            ...
            <Card className="mt-6">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Shield className="h-5 w-5 text-primary" /> Safety Notices
                </CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-muted-foreground">
                <p>
                  Alerts are generated by the onboard vision model and water
                  sensors. Manual control is disabled while in Auto mode.
                </p>
                <Separator className="my-3" />
                <p>
                  Integrate your camera RTSP/HTTP streams and robot API
